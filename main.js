...
var num1 = 14;
var num2 = 88;
document.getElementById("q4a").innerHTML = num2 - num1;
document.getElementById("q4b").innerHTML = num1 / num2;
...
var learning = "It's so fun ";
var fun = "to learn!";
var fullSentence = learning+=fun;
document.getElementById("q5").innerHTML = fullSentence;
...
var five = "5";
var three = "3";
document.getElementById("q6a").innerHTML = five + three;
document.getElementById("q6b").innerHTML = five - three;
document.getElementById("q6c").innerHTML = five * three;
document.getElementById("q6d").innerHTML = five / three;
document.getElementById("q6note").innerHTML = "Strings can be concatenated through the + symbol. However, they cannot be subracted, divided, or multiplied without coercing the strings into numbers.";
...
document.getElementById("callAlert").addEventListener("click", function() {
    document.getElementById("q7").innerHTML = "Now it's been clicked!"
}
)
...
document.getElementById("callDoubleNum").addEventListener("click", function() {
        var userText = document.getElementById("doubleNum").value;
        document.getElementById("q8").innerHTML = userText * 2;
}
)
...
var score = 87
if(score >= 90) {
    var result = "Great job";
} else if(score >= 60 && score <=89) {
    var result = "Nice work, keep practicing";
} else {
    var result = "Very bad: study more and retake the test."
}

document.getElementById("q10").innerHTML = score + " " + result;
